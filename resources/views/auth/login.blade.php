        ...
        <div class="authentication-inner row">
            <div class="d-none d-lg-flex col-lg-7 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="{{ asset('asset-template/img/illustrations/auth-login-illustration-light.png') }}"
                        alt="auth-login-cover" class="img-fluid my-5 auth-illustration"
                        data-app-light-img="illustrations/auth-login-illustration-light.png"
                        data-app-dark-img="illustrations/auth-login-illustration-dark.png" />

                    <img src="{{ asset('asset-template/img/illustrations/bg-shape-image-light.png') }}"
                ...
                <div class="w-px-400 mx-auto">
                    <div class="app-brand mb-4">
                        <span class="app-brand-logo w-100 mb-5">
                            <img src="{{ asset('asset-template/img/icons/brands/react-label.png') }}" class="w-100" />
                        </span>
                    </div>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                id="username" name="email" placeholder="Enter your username" required
