    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <ol class="breadcrumb text-muted fs-6 fw-bold">
                ...
                <li class="breadcrumb-item pe-3"><span class="pe-3 text-dark">Manajemen User No Aktif</span></li>
            </ol>
        </div>
    </div>
    <hr>
    ...
    $(document).on('click', '.btn-hapus', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ route('userNoHapus', '') }}/" + btnId;
            }
        });
    });
