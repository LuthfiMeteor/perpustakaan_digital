                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input type="text" name="kategori" id="kategori" class="form-control" autocomplete="off"
                                    required>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="editjudul" id="editjudul" class="form-control"
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <input type="text" name="editpenulis" id="editpenulis" class="form-control"
                                    autocomplete="off" required>
                            </div>
                            <div class="col-lg-12 mt-3">
                                <label class="form-label" for="kategori">Kategori
                                ...
                                <input type="text" name="editkategori" id="editkategori" class="form-control"
                                    autocomplete="off" required>
                            </div>
                            <div class="col-lg-6 mt-3">
                                <label class="form-label" for="buku">Upload Buku
                                ...
                                <input type="file" name="editbuku" id="editbuku" class="form-control"
                                    accept=".pdf, .doc, .docx">
                            ...
                            <div class="col-lg-6 mt-3">
                                ...
                                <input type="file" name="editcover" id="editcover" class="form-control"
                                    accept="image/*">
