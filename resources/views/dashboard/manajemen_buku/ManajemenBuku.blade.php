    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST"  id="formUpdate" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" name="editjudul" id="editjudul" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-lg-12 mt-3">
                            <label class="form-label" for="penulis">Penulis
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="editpenulis" id="editpenulis" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-lg-12 mt-3">
                            <label class="form-label" for="kategori">Kategori
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="editkategori" id="editkategori" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-lg-6 mt-3">
                            <label class="form-label" for="buku">Upload Buku
                                <span class="text-danger">*</span>
                            </label>
                            <input type="file" name="editbuku" id="editbuku" class="form-control" accept=".pdf, .doc, .docx">
                        ...
                        <div class="col-lg-6 mt-3">
                            ...
                            <input type="file" name="editcover" id="editcover" class="form-control" accept="image/*">
                        ...
                        <div class="col-lg-12 mt-3">
                            ...
                            <div id="editor1">
                                <textarea name="editdeskripsi" id="editdeskripsi" class="form-control" required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-info" id="btnSubmitUpdate">
                        <span class="indicator-label">
                            Update
                        </span>
