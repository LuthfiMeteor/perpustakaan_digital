             ...
             <div class="row gx-0 gy-4 g-md-5">
                 ...
                 <div class="col-lg-3 col-md-4">
                     ...
                     <a href="javascript:void(0);" class="d-block footer-link mb-3 pb-2"><img
                             src="{{ asset('asset-template/img/front-pages/landing-page/apple-icon.png') }}"
                             alt="apple icon" /></a>
                     <a href="javascript:void(0);" class="d-block footer-link"><img
                             src="{{ asset('asset-template/img/front-pages/landing-page/google-play-icon.png') }}"
         ...
         <div
             ...
             <div>
                 <a href="https://github.com/pixinvent" class="footer-link me-3" target="_blank">
                     <img src="{{ asset('asset-template/img/front-pages/icons/github-light.png') }}" alt="github icon"
                 ...
                 <a href="https://www.facebook.com/pixinvents/" class="footer-link me-3" target="_blank">
                     <img src="{{ asset('asset-template/img/front-pages/icons/facebook-light.png') }}"
                 ...
                 <a href="https://twitter.com/pixinvents" class="footer-link me-3" target="_blank">
                     <img src="{{ asset('asset-template/img/front-pages/icons/twitter-light.png') }}"
                 ...
                 <a href="https://www.instagram.com/pixinvents/" class="footer-link" target="_blank">
                     <img src="{{ asset('asset-template/img/front-pages/icons/instagram-light.png') }}"
