        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
            ...
            <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link fw-medium {{ Request::route()->getName() == 'landing' ? 'active' : '' }}" aria-current="page" href="{{ route('landing') }}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-medium {{ Request::route()->getName() == 'book-list' ? 'active' : '' }}" href="{{ route('book-list')}}">Book List</a>
                    </li>
                </ul>
            </div>
