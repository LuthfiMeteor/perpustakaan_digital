...
route::get('book-list', [BukuUserController::class, 'index'])->name('book-list');
route::get('book-detail/{id}', [BukuUserController::class, 'show'])->name('bookDetail');
...
route::group(['middleware' => 'role:user'], function () {
    route::post('favorit', [BukuUserController::class, 'favorite'])->name('favorit');
    route::post('kirim-komentar', [BukuUserController::class, 'kirimKomentar'])->name('kirimKomentar');
    route::get('bacaBuku/{id}', [BukuUserController::class, 'bacaBuku'])->name('bacaBuku');
    route::get('favorite', [BukuUserController::class, 'favorite'])->name('favorite');
    route::get('favorit-list', [BukuUserController::class, 'favoriteList'])->name('favoriteList');
});
